...
import {mapActions, mapState} from 'vuex'
  ...
  export default {
    ...
    data(){
      return {
        items: [
          { title: 'Usuarios', icon: 'mdi-account', link: '/dashboard' },
          { title: 'Categoria', icon: 'mdi-format-size', link: '/typography' },
          { title: 'Producto', icon: 'mdi-store', link: '/tables' },
          { title: 'Proveedor', icon: 'mdi-truck', link: '/notifications' },
          {
            title: 'UI Elements',
